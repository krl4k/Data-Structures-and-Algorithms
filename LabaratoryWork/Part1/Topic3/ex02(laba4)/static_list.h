...
void	push_sort(t_static_list *list, char *data);

void	push_back(t_static_list *list, char *data);
void	push_front(t_static_list *list, char *data);

/*!
* \param2 data the element to which the addition occurs
* \param3 DATA for a new item
*/
void	push_before(t_static_list *list, char *elem, char *data);
void	push_after(t_static_list *list, int elem, int data);
